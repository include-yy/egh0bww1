...
- 我于 2026 年初完成了对 [[file:posts/2022-02-22-17-setf-CL-five-gangs-elisp-high-order-approach/index.org][setf 之 CL 的 five gangs 与 elisp 的 high-order approach]] 的重构，目前还有两件事要做，以完成 Generalized Variable 三部曲：
  - [ ] 完成对 GV 历史的考古
  - [ ] 记录一些实用 GV 例子
...
- 参考 Org-mode 的 ox-html.el，完成对 [[https://github.com/include-yy/ox-w3ctr][ox-w3ctr]] 的重构，即代码整理以及编写对应文档。在开始 special-block 的重构之前，应首先完成如下两部分的学习和博客记录：
  ...
  - [ ] @@html:<span style="color:red">@@​*学习如何使用 ERT 编写良好且可维护的单元测试，或称回归测试*​@@html:</span>@@
...
- 25 年年初我写了 [[file:posts/2025-02-24-aitac-1/index.org][「笔记」An Invitation to Applied Category Theory — Chapter 1]]，这本书是范畴论的入门级教程，目前还剩 2 到 7 章没有读和记笔记
  - [ ] @@html:<span style="color:red">@@​*「笔记」An Invitation to Applied Category Theory — Chapter 2*​@@html:</div>@@
...
- [ ] 学会可持续性地整理资料
- [ ] 学点日语
- [ ] @@html:<span style="color:red">@@​*学点基金知识和理财知识*​@@html:</span>@@
** FUN
...
#+begin_export js
(function () {
    const reds = document.querySelectorAll('span[style*="color:red"]');
    if (reds.length === 0) return;
    let container = document.getElementById('RedTargets');
    if (!container) return;
...
- [[https://plumz.me/][Plum's Blog]]
  - [[https://plumz.me/archives/14403/][关于 39 岁对于死亡的焦虑]]
