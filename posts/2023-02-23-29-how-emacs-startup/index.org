...
#+YYNTRSS: 本文根据 Elisp Manual 41.1 节以及 emacs 28.2 的源代码，对 emacs 的启动过程进行了简单介绍
...
#+BEGIN_SRC c :summary main 中对 Vtop_level 的处理，以及 top_level 初始化函数
  // emacs.c line 2307
  if (!initialized)
  {
      char *file;
...
#+BEGIN_SRC text :summary emacs --help
emacs --help
