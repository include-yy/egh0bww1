...
[fn:2] My favourite example of this is best expressed as a Parsing Expression Grammar (PEG): {{{br}}}
#+BEGIN_SRC text
  r <- a / ab
#+END_SRC
or as a hand-written recursive descent parser: {{{br}}}
#+BEGIN_SRC python
  def r(s, i):
...
[fn:17] Off-hand, I can only think of a single example: when Lukas tried to evolve [[https://github.com/softdevteam/grammars/tree/master/java7][this Java 7 grammar]] to Java 8. Until that point, grmtools did not have a way of reporting details about conflicts because I hadn’t needed such a feature! {{{br}}}
