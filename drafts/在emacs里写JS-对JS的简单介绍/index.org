...
原本我准备一篇文章直接完成对 JS 的介绍、对 emacs mode 的介绍和写一个简单 mode 三部分内容，写着写着我发现我对 JS 缺乏一个全面的认识，要不干脆写一个系列吧。它会包括以下内容：
...
本文即对 JavaScript 的简单介绍。在开始这一节之前我们先来点 JS [[https://www.yazeedb.com/posts/explaining-the-best-javascript-meme-i-have-ever-seen][meme]]：
